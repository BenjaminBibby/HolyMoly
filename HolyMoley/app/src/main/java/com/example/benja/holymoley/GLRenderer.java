...
public class GLRenderer
{
    ...
    private float screenScaleUniform;
    ...
    public GLRenderer(Context context, int[] resourceIDs)
    {
        ...
        this.screenScaleUniform = 1.0f;
        this.defaultScreenWidth = 1920;
        this.defaultScreenHeight = 1080;

        this.projectionMatrix = new float[16];
        this.viewMatrix = new float[16];
        this.projectionAndViewMatrix = new float[16];
